...
```{r my-figure1, echo=FALSE, fig.cap="(ref:my-figure-caption)", message=FALSE, warning=FALSE}
...
```{r my-figure, echo=FALSE, fig.cap="(ref:my-figure-caption)", dev='png', dpi=300, fig.asp=0.7, message=FALSE, warning=FALSE}
semPaths(UWES_replicated_errors,layout = "tree2", whatLabels= "std",
         residuals = T, thresholds = F,        
         reorder = T, edge.label.cex= 1, fade=F, 
         intercepts = F, rotation = 1,
...
publication_name_map <- c(
  ...
  "DFI_one_factor"        = "Model 1 One Factor",
  "DFI_hierarch_factor"   = "Model 2 Hierarchical",
  "DFI_three_factor"      = "Model 3 Three Factor Standard",
  "DFI_two_factor"        = "Model 4a Two Factor Vigor Dedication",
  "dfi_two_factor_chaudhary" = "Model 4b Two Factor Vigor Absorption",
  "DFI_two_factor_panthee"   = "Model 4c Two Factor Dedication Absorption",
  ...
  "dfi_three_factor_corr_error_littman_ovadia" = "Model 5d Modified 3F Littman Ovadia",
